...
def solve(grid: list) -> list:
    ...
    """ Как решать Судоку?
        ...
        2. Найти все возможные значения, которые могут находиться на позиции
...
def check_solution(solution: list) -> bool:
    """ Если решение solution верно - вернуть True, в противном - False """
